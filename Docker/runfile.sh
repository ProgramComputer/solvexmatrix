...
mv -f /makefile_unix ~/Downloads/PHCv2_4p/Objects
mv -f /index.html.j2 /usr/local/share/jupyter/voila/templates/lab
mv -f /favicons /usr/local/share/jupyter/voila/templates/base/static
